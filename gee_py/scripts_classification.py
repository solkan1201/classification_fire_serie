...
dict_year_rois = {
    '2001': 'LE07_204031_20010915_normal_rois', 
    '2002': 'LE07_204031_20021004_normal_rois', 
    '2003': 'LE07_204031_20021004_normal_rois', 
    '2004': 'LT05_204031_20051004_normal_rois', 
    '2005': 'LT05_204031_20051004_normal_rois',
    '2006': 'LT05_204031_20060804_normal_rois', 
    '2007': 'LT05_204031_20060804_normal_rois', 
    '2008': 'LT05_204031_20060804_normal_rois', 
    '2009': 'LT05_204031_20060804_normal_rois', 
    '2010': 'LT05_204031_20110919_normal_rois',
    '2011': 'LT05_204031_20110919_normal_rois', 
    '2012': 'LE07_204031_20010915_normal_rois', 
    '2013': 'LC08_204031_20131010_normal_rois', 
    '2014': 'LC08_204031_20131010_normal_rois', 
    '2015': 'LC08_204031_20160916_normal_rois',
    '2016': 'LC08_204031_20160916_normal_rois', 
    '2017': 'LC08_204031_20170903_normal_rois', 
    '2018': 'LC08_204031_20170903_normal_rois', 
    '2019': 'LC08_204031_20170903_normal_rois', 
    '2020': 'LC08_204031_20170903_normal_rois'
}
...
bands_L57 = ["B1","B3","B4","B5","B7"]
bands_L8 = ["B2","B4","B5","B6","B7"]
bnds_name = ["blue","red","nir","swir1","swir2"]
primer = True
lst_mais_tres = []
...
for year_current in params['lst_year']:
    ...
    roi_year = ee.FeatureCollection(params['asset_rois'] + dict_year_rois[year_current])

    columnaTraining = {
        '2001': ['dmirbi', 'dnbr', 'dndvi', 'dnirr', 'evi', 'mirbi', 'nbr', 'nir', 'swir1', 'red', 'savi'],
        '2002':  ['dmirbi', 'dnbr', 'dndvi', 'dnirr', 'evi', 'mirbi', 'nbr', 'nir', 'swir1', 'red', 'savi'],
    }
    ...
    serializeClassificador = ee.Classifier.smileRandomForest(**pmtRF).train(roi_year , 'class', columnaTraining[year_current])
    lst_mais_tres = lst_indexImage[:-3]

    for cc, index_img in enumerate(lst_indexImage[:5]):
        ...
        if cc >= 3:
            ...
            strId = index_img[: -7]
            strId_pre = lst_indexImage[cc - 3][: -7]
