...
var IndiceIndicadorAgua = function(img){
    var iaImg = img.expression(
        "float((b('B3') - 4 *  b('B8')) / (b('B3') + 4 *  b('B8')))").rename("iia");

return img.addBands(iiaImg);
}
var agregateBandsIndexSoil = function(img){
    var soilImg = img.expression(
        "float(b('B8') - b('B3')) / (b('B8') + b('B3'))").rename(['isoil']);       
...
var mancha = ee.Image(params.asset_inputS + '/LT05_204031_20051004_normal')
var limitPT = ee.FeatureCollection(params.limitPort)
var imgLandsat = ee.Image('LANDSAT/LT05/C01/T1_SR/LT05_204031_20051004')
var imgLandsat_pre = ee.Image('LANDSAT/LT05/C01/T1_SR/LT05_204031_20050817')

var roi_year = ee.FeatureCollection(params.asset_rois + '/' + 'LT05_204031_20051004_normal_rois')
...
var imgLandsatl = ee.Image('LANDSAT/LT05/C01/T1_SR/LT05_204031_20051004')
...
Map.addLayer(imgLandsatl, vistoa,'l5', true);
...
def IndiceIndicadorAgua(self, img):
        ...
        return img.addBands(iiaImg)
ef agregateBandsIndexSoil(self, img):
